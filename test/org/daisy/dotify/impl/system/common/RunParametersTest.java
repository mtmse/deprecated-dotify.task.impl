...
public class RunParametersTest {
	...
	public void testDefaultWidth() {
		...
		assertEquals(35, map.get(RunParameters.PAGE_WIDTH));
		assertEquals(5, map.get(RunParameters.INNER_MARGIN));
		assertEquals(2, map.get(RunParameters.OUTER_MARGIN));
	}
	...
	public void testRowSpacing_01() {
		...
		assertEquals(1.0f, map.get(RunParameters.ROW_SPACING));
	}
	...
	public void testRowSpacing_02() {
		...
		assertEquals(2.0f, map.get(RunParameters.ROW_SPACING));
	}
	...
	public void testRowSpacing_03() {
		...
		assertEquals(1.5f, map.get(RunParameters.ROW_SPACING));
	}
